...
cd ${APP_PATH} && docker-compose -f ${APP_COMPOSE_FILE_PATH} down && docker-compose -f ${APP_COMPOSE_FILE_PATH} up -d && docker-compose -f ${APP_COMPOSE_FILE_PATH} logs -tf --tail=1000
